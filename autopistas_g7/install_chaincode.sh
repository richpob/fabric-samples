...
//probar el chaincode
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.autopistasmop.com --tls --cafile ${PWD}/organizations/ordererOrganizations/autopistasmop.com/orderers/orderer.autopistasmop.com/msp/tlscacerts/tlsca.autopistasmop.com-cert.pem -C autopistaschannel -n tollchaincode --peerAddresses localhost:7051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/org1.autopistasmop.com/peers/peer0.org1.autopistasmop.com/tls/ca.crt -c '{"function":"InitLedger","Args":[]}'
peer chaincode query -C autopistaschannel -n tollchaincode -c '{"Args":["GetAllAssets"]}'

peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.autopistasmop.com --tls --cafile ${PWD}/organizations/ordererOrganizations/autopistasmop.com/orderers/orderer.autopistasmop.com/msp/tlscacerts/tlsca.autopistasmop.com-cert.pem -C autopistaschannel -n tollchaincode --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/org2.autopistasmop.com/peers/peer0.ruta78.autopistasmop.com/tls/ca.crt -c '{"function":"CreateAsset","Args":["asset8","green","16","Sergio","750"]}'
peer chaincode query -C autopistaschannel -n tollchaincode -c '{"Args":["GetAllAssets"]}'
